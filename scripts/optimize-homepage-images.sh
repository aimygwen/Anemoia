...
echo "→ Hero poster"
to_jpeg "assets/base.png" "assets/base.jpg" 1600 82
...
echo "Done. Sizes:"
ls -lh assets/base.jpg assets/favorite_*.jpg assets/thumbnails/*.{jpg,JPG} assets/komorebi.jpg assets/polaroid.JPG 2>/dev/null
