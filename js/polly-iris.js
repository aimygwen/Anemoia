/**
 * Polly iris — pupils look toward the cursor, clamped inside each eye socket.
 * Iris sits under Face (eye cutouts) — keep that stack order.
...
(function () {
  ...
  function collectFromMark(svg) {
    ...
    var nodes = svg.querySelectorAll(".brand-layer--iris .iris-pupil[data-iris]");
